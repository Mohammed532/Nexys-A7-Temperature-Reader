# 0 "C:\\Users\\Mo\\Documents\\A7-50T_Temperature_Reader\\tr_vitis_workspace\\a750t_temp_sensor\\hw\\sdt\\system-top.dts"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "C:\\Users\\Mo\\Documents\\A7-50T_Temperature_Reader\\tr_vitis_workspace\\a750t_temp_sensor\\hw\\sdt\\system-top.dts"
/dts-v1/;
# 1 "C:\\Users\\Mo\\Documents\\A7-50T_Temperature_Reader\\tr_vitis_workspace\\a750t_temp_sensor\\hw\\sdt\\pl.dtsi" 1
/ {
 cpus_microblaze_0: cpus_microblaze@0 {
  ...
  microblaze_0: cpu@0 {
   ...
   xlnx,use-icache = <1>;
   d-cache-size = <32768>;
   xlnx,memory-ip-list = "microblaze_0_local_memory_ilmb_bram_if_cntlr_memory" , "microblaze_0_local_memory_dlmb_bram_if_cntlr_memory" , "mig_7series_memory" , "mig_7series_memory";
   xlnx,async-wakeup = <3>;
 ...
 amba_pl: amba_pl {
  ...
  axi_gpio_seven_seg: gpio@40010000 {
   #interrupt-cells = <2>;
   interrupts = < 0 2 >;
   xlnx,gpio-board-interface = "dual_seven_seg_led_disp";
   compatible = "xlnx,axi-gpio-2.0" , "xlnx,xps-gpio-1.00.a";
   xlnx,all-outputs = <1>;
   #gpio-cells = <2>;
   xlnx,gpio-width = <8>;
...
# 3 "C:\\Users\\Mo\\Documents\\A7-50T_Temperature_Reader\\tr_vitis_workspace\\a750t_temp_sensor\\hw\\sdt\\system-top.dts" 2
/ {
 board = "nexys-a7-50t";
