...
#ifndef _temp_reader_bd_microblaze_0_xlconcat_0_core_h_
#define _temp_reader_bd_microblaze_0_xlconcat_0_core_h_
...
class temp_reader_bd_microblaze_0_xlconcat_0_core : public sc_module 
{
    public: 
       temp_reader_bd_microblaze_0_xlconcat_0_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , In0    ( "In0" )
              , In1    ( "In1" )
              , In2    ( "In2" )
              , dout   ( "dout" )
    {
        SC_HAS_PROCESS(temp_reader_bd_microblaze_0_xlconcat_0_core);
    ...
    virtual ~temp_reader_bd_microblaze_0_xlconcat_0_core() = default;
